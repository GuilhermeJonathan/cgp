...
namespace Cgp.Dominio.Repositorios
{
    public interface IRepositorioDeUsuarios : IRepositorio<Usuario>
    {
        ...
        IList<Usuario> RetornarUsuariosPorFiltro(string nome, string email, int batalhao, bool ativo, bool ehAtenas, int perfil, int pagina, int registrosPorPagina, out int quantidadeEncontrada);
