...
namespace Cgp.Dominio.Repositorios
{
    ...
    {
        IList<Carater> RetornarCaratersPorFiltro(int[] cidades, int[] crimes, int situacao, DateTime? dataTarefaInicial, DateTime? dataTarefaFinal, out int quantidadeEncontrada);
